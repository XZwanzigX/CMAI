<html>
    ...
    <p><em class="class-heading">Basic Riding<br>
    ...
    <p><span class="class-time">9:00a</span>             	<span class="class-name">Beginning Riding 1:</span><br>

    <span>Instructor:</span> Tina Walsh<br>
    Required Equipment: Boots with heel, comfortable long pants (riding pants recommended)</p>

    <p><span class="class-time">1:30p</span>            	<span class="class-name">Beginning Riding 2:</span><br>
    ...
    <p><span class="class-time">9:00a</span>            	<span class="class-name">Beginning Riding 3:</span><br>
    <span>Instructor:</span> Tina Walsh<br>
    Required Equipment: Boots with heel, comfortable long pants (riding pants recommended)</p>

    <p><span class="class-time">1:30p</span>            	<span class="class-name">Beginning Riding 4:</span><br>
    <span>Instructor:</span> Tina Walsh<br>
    Required Equipment: Boots with heel , comfortable long pants (riding pants recommended)</p>

    <p class="day-heading">Day 3</p>
    <p><span class="class-time">9:00a</span>            	<span class="class-name">Beginning Riding 5:</span><br>
    <span>Instructor:</span> Tina Walsh<br>
    Required Equipment: Boots with heel , comfortable long pants (riding pants recommended)</p>
    ...
    <p><span class="class-time">5:00p</span>             	<span class="class-name">Mounted Combat 1: Rolling and Falling from Horseback</span><br>
    ...
    <p><span class="class-time">5:00p</span>             	<span class="class-name">Mounted Combat 2: Riding for Combat</span><br>
    <span>Instructor:</span> Theresa Wendland<br>
    ...
    <p><span class="class-time">5:00p</span>             	<span class="class-name">Mounted Combat 2: Introduction to Fiore's Sword on Horseback</span><br>
    <span>Instructor:</span> Theresa Wendland<br>
    <span>Required Equipment:</span> Boots with heel , comfortable long pants (riding pants recommended)<br>
    ...
    <p><span class="class-time">10:45a</span>           	<span class="class-name">Jousting 1: The Riders Seat</span><br>
    ...
    <p><span class="class-time">3:15p</span>            	<span class="class-name">Jousting 2: Weapons Handling</span><br>
    <span>Instructor:</span> Luke Binks<br>
    <span>Required Equipment:</span> Boots with heel , comfortable long pants (riding pants recommended). No armour required<br>
    ...
    <p> <span class="class-time">10:45a</span>            	<span class="class-name">Jousting 3: Riding in Armour</span><br>
    <span>Instructor:</span> Luke Binks<br>
    ...
    <p><span class="class-time">3:15p</span>            	<span class="class-name">Jousting 4: Weapons Handling in Armour</span><br>
    <span>Instructor:</span> Luke Binks<br>
    <span>Required Equipment:</span> Armour required<br>
    ...
    <p><span class="class-time">10:45a</span>            	<span class="class-name">Jousting 5: The Joust</span><br>
    <span>Instructor:</span> Luke Binks<br>
    <span>Required Equipment:</span> Armour required<br>
    ...
    <p><span class="class-time">AM1</span> 		<span class="class-name">Introduction to armor, weapons and the rules</span><br>
    ...
    <p><span class="class-time">AM2</span> 		<span class="class-name">Great Stick</span><br>
    ...
    <p><span class="class-time">PM1</span>              	<span class="class-name">"God, the Art, myself, and my sword": Fiore de Liberi's Unarmoured Combat</span><br>
    <span>Instructor:</span> Sean Hayes<br>
    <span>Required Equipment:</span> sword, gorget, mask or helmet.</p>

    <p><span class="class-time">PM2</span>             	<span class="class-name">Taking Control of the Dagger Fight</span><br>
    ...
    <p><span class="class-time">PM3</span>            	<span class="class-name">Selected sword techniques of Gladiatoria  II</span><br>
    ...
    <p><span class="class-time">AM1</span>            	<span class="class-name">Selected Mordschlag techniques of Gladiatoria  II-</span>
    <span>Instructor:</span> Dierk Hagedorn<br>
    <span>Required Equipment:</span> longsword, some harness preferable<br>
    ...
    <p><span class="class-time">AM2</span>            	<span class="class-name">Two-Ubiquitous Throws of Armizare</span><br>
    <span>Instructor:</span> Greg Mele<br>
    <span>Required Equipment:</span> Everything.</p>

    <p><span class="class-time">PM1</span>            	<span class="class-name">The old fallback, dagger against other weapons</span><br>
    ...
    <p><span class="class-time">PM2</span> 		<span class="class-name">Selected sword techniques of Gladiatoria III</span><br>
    <span>Instructor:</span> Dierk hagedorn<br>
    ...
    <p><span class="class-time">PM3</span>             	<span class="class-name">Fundamentals of the system - footwork, guards, blows and parries. aka "Pollaxe for Dummies"</span><br>
    ...
    <p><span class="class-time">AM1</span>            	<span class="class-name">Train what you Fight: from Cutting Drill to Solo Form to Partnered Exercise</span><br>
    <span>Instructor:</span> Greg Mele<br>
    <span>Required Equipment:</span> Everything.</p>

    <p><span class="class-time">AM2</span>            	<span class="class-name">Hooks, disarms and binds: Intricacies of the Knightly Swiss army knife</span><br>
    <span>Instructor:</span> Jason Smith<br>
    <span>Required Equipment:</span> Pollaxe simulator<br>
    ...
    <p><span class="class-time">PM1</span>            	<span class="class-name">Fighting multiple opponents-</span><br>
    ...
    <p><span class="class-time">PM2</span>            	<span class="class-name">Selected dagger techniques of Gladiatoria --IV</span><br>
    <span>Instructor:</span> Dierk Hagedorn<br>
    ...
    <p><span class="class-time">PM3</span>             	<span class="class-name">The sinister pollaxe: Playing from the left in Le Jeu --</span>
    <span>Instructor:</span> Jason Smith<br>
    ...
    <p><span class="class-time">AM1</span>            	<span class="class-name">Sword in Armour: Fighting at the Full Sword and the Half Sword--</span><br>
    <span>Instructor:</span> Sean Hayes<br>
    <span>Required Equipment:</span> sword, harness<br>

    <p><span classs="class-time">AM2</span>            	<span class="class-name">open</span><br>
    <p><span classs="class-time">PM1</span>            	<span class="class-name">open</span><br>
    <p><span classs="class-time">PM2</span>            	<span class="class-name">open</span><br>
    <p><span classs="class-time">PM3</span>            	<span class="class-name">open</p>
